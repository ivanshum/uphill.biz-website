...
type Query_allSanityPageArgs = {
  ...
  limit: InputMaybe<Scalars['Int']>;
  skip: InputMaybe<Scalars['Int']>;
  sort: InputMaybe<ReadonlyArray<InputMaybe<SanityPageSortInput>>>;
};
...
type SanityPage = Node & SanityDocument & {
  readonly _createdAt: Maybe<Scalars['Date']>;
  readonly _id: Maybe<Scalars['String']>;
  readonly _key: Maybe<Scalars['String']>;
  readonly _rev: Maybe<Scalars['String']>;
...
type SanityPageConnection_maxArgs = {
  field: SanityPageFieldSelector;
};


type SanityPageConnection_minArgs = {
  field: SanityPageFieldSelector;
};


type SanityPageConnection_sumArgs = {
  field: SanityPageFieldSelector;
};
...
type SanityPageGroupConnection_distinctArgs = {
  field: SanityPageFieldSelector;
};


type SanityPageGroupConnection_groupArgs = {
  field: SanityPageFieldSelector;
  limit: InputMaybe<Scalars['Int']>;
  skip: InputMaybe<Scalars['Int']>;
};
...
type SanityPageGroupConnection_maxArgs = {
  field: SanityPageFieldSelector;
};


type SanityPageGroupConnection_minArgs = {
  field: SanityPageFieldSelector;
};


type SanityPageGroupConnection_sumArgs = {
  field: SanityPageFieldSelector;
};
...
type IndexPageQuery = { readonly sanityPage: { readonly title: string | null } | null };
